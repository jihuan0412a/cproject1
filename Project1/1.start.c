...
#pragma region 필기
//1) #include <stdio.h>#include <stdio.h> 프로그램 코드 내에 c언어의 입력.출력 기능을 사용하기 위해 추가해야 하는 코드
...
//	 return 다음에는 전달할 값을 작성할 수 있습니다. 이 떄 전달하는 값은 함수의 데이터 형태에 따라 결정됩니다

//5) ;(세미콜론)은 c언어에서 명령문의 마지막에 붙여주는 기호입니다.

//6) {}(블록) 코드의 작성 법위(scope)를 표현하는 기호입니다.
#pragma endregion